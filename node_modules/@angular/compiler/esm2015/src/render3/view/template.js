...
export class TemplateDefinitionBuilder {
    ...
    i18nEnd(span = null, selfClosing) {
        ...
        if (bindings.size) {
            bindings.forEach(binding => {
                this.updateInstruction(index, span, R3.i18nExp, () => [this.convertPropertyBinding(binding)]);
            });
            ...
            if (inputType === 4 /* Animation */) {
                ...
                if (value !== undefined) {
                    ...
                    if (inputType === 0 /* Property */) {
                        if (value instanceof Interpolation) {
                            this.updateInstruction(elementIndex, input.sourceSpan, getPropertyInterpolationExpression(value), () => [o.literal(attrName), ...this.getUpdateInstructionArguments(value),
                                ...params]);
                        }
                        else {
    ...
    visitBoundText(text) {
        ...
        const value = text.value.visit(this._valueConverter);
        this.allocateBindingSlots(value);
        this.updateInstruction(nodeIndex, text.sourceSpan, R3.textBinding, () => [o.literal(nodeIndex), this.convertPropertyBinding(value)]);
    }
    visitText(text) {
    ...
    templatePropertyBindings(template, templateIndex, attrs) {
        attrs.forEach(input => {
            if (input instanceof t.BoundAttribute) {
                const value = input.value.visit(this._valueConverter);
                this.allocateBindingSlots(value);
                this.updateInstruction(templateIndex, template.sourceSpan, R3.property, () => [o.literal(input.name), this.convertPropertyBinding(value, true)]);
            }
        });
    }
